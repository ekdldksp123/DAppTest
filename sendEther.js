...
const receive_account = '0x72f3f648D30A56dC67FC55B85d14846b7Fe39fA7' 
...
//typescript 적용하기
const sendEther = async (web3) => {

    //promise -> async ~ await 으로 변경해서 다시 테스뚜!
    await web3.eth.getTransactionCount(send_account)
        .then((err, txCount) => { //step 1
